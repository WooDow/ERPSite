...
@NamedQueries({
    ...
    , @NamedQuery(name = "Employees.findByPasswd", query = "SELECT e FROM Employees e WHERE e.passwd = :passwd")})
public class Employees implements Serializable {
    ...
    public Employees(Integer employeeNumber, String lastName, String firstName, String extension, String email, String jobTitle, String passwd) {
        this.employeeNumber = employeeNumber;
    ...
    public String toString() {
        return "tw.mymis.model.Employees[ employeeNumber=" + employeeNumber + " ]";
    }
